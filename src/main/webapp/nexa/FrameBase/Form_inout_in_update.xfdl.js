(function()
{
    return function()
    {
        ...
        {
            this.set_name("Form_inout_in_update");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CROPS_NO\" type=\"STRING\" size=\"256\"/><Column id=\"CROPS_S\" type=\"STRING\" size=\"256\"/><Column id=\"CROPS_M\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CROPS_NO\">A001</Col><Col id=\"CROPS_M\">고구마</Col></Row><Row><Col id=\"CROPS_NO\">B001</Col><Col id=\"CROPS_M\">감자</Col></Row></Rows>");
            ...
            obj = new Static("lb_in_update","0%","0%","100%","8.33%",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("입고 수정");
            ...
            obj = new Button("btn_in_update","85.71%","90.83%","12.99%","7.08%",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_text("수정");
            obj.set_background("#333F50");
            obj.set_border("0px none transparent");
        ...
        // User Script
        this.registerScript("Form_inout_in_update.xfdl", function() {
        /* 거래처 코드 조회 popupdiv */
        ...
        this.loadIncludeScript("Form_inout_in_update.xfdl");
