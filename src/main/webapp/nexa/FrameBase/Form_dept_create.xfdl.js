(function()
{
    return function()
    {
        ...
        {
            this.set_name("Form_dept_create");
            ...
            obj = new Static("lb_dept_create","0%","0%","100%","10%",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("부서 등록");
            ...
            obj = new Static("lb_dept_create_center","2.5%","12.5%","95%","73.25%",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Button("btn_dept_create","72.5%","89%","25%","8.5%",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("등록");
            obj.set_background("#333F50");
            obj.set_border("0px none transparent");
        ...
        // User Script
        this.registerScript("Form_dept_create.xfdl", function() {
        ...
        this.btn_dept_create_onclick = function(obj,e)
        {
        	//alert("부서등록버튼 클릭");
        ...
        {
            this.addEventHandler("onload",this.Form_dept_create_onload,this);
            this.btn_dept_no_check.addEventHandler("onclick",this.btn_dept_no_check_onclick,this);
            this.btn_dept_create.addEventHandler("onclick",this.btn_dept_create_onclick,this);
        };

        this.loadIncludeScript("Form_dept_create.xfdl");
