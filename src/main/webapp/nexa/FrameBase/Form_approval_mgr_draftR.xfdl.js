(function()
{
    return function()
    {
        ...
        {
            this.set_name("Form_approval_mgr_draftR");
            ...
            obj = new Dataset("ds_approval_preserveList", this);
            ...
            obj = new Static("lb_approval_mgr_draftR","0%","0%","100%","6.35%",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("기안서-반려");
            ...
            obj = new Static("lb_approval_mgr_draftR_center","1.30%","20.63%","97.27%","70.48%",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj.set_enable("false");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell text=\"1차 결재자\" textAlign=\"center\" verticalAlign=\"middle\"/><Cell col=\"1\" text=\"2차 결재자\" textAlign=\"center\" verticalAlign=\"middle\"/><Cell col=\"2\" text=\"최종 결재자\" textAlign=\"center\" verticalAlign=\"middle\"/></Band><Band id=\"body\"><Cell text=\"bind:APPROVAL_1ST\"/><Cell col=\"1\" text=\"bind:APPROVAL_2ND\" textAlign=\"center\" verticalAlign=\"middle\"/><Cell col=\"2\" text=\"bind:APPROVAL_3RD\" textAlign=\"center\" verticalAlign=\"middle\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("Form_approval_mgr_draftR.xfdl", function() {
        /* 결재자 선택 그리드 */
        ...
        this.Form_approval_mgr_draftR_onload = function(obj,e)
        {
        	var p_apprcode = objDs.getColumn(0,"APPROVAL_CODE");
        	//ert("APPROVAL_CODE(자식창) : " + p_apprcode);
        ...
        {
            this.addEventHandler("onload",this.Form_approval_mgr_draftR_onload,this);
        ...
        this.loadIncludeScript("Form_approval_mgr_draftR.xfdl");
