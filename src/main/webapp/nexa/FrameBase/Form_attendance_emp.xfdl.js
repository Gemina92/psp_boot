(function()
{
    return function()
    {
        ...
        {
            this.set_name("Form_attendance_emp");
            ...
            obj = new Static("lb_attendance_emp","0%","0%","100%","5.22%",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("근태 조회");
            ...
            obj = new Div("div_attendance_emp","0%","0%","100%","100%",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            this.addChild(obj.name, obj);

            obj = new Static("lb_attendance_emp_search","2.03%","7.31%","96.09%","11.94%",null,null,null,null,null,null,this.div_attendance_emp.form);
            obj.set_taborder("0");
            ...
            this.div_attendance_emp.addChild(obj.name, obj);

            obj = new Static("lb_date","5.63%","11.04%","7.81%","4.48%",null,null,null,null,null,null,this.div_attendance_emp.form);
            obj.set_taborder("1");
            obj.set_text("조회기간");
            obj.set_font("14px/normal \"Malgun Gothic\",\"Arial\"");
            obj.set_color("black");
            ...
            obj = new Calendar("cal_start_date","11.48%","10.75%","15.63%","5.22%",null,null,null,null,null,null,this.div_attendance_emp.form);
            obj.set_taborder("2");
            obj.set_type("normal");
            obj.set_dateformat("yyyy-MM-dd");
            this.div_attendance_emp.addChild(obj.name, obj);

            obj = new Static("lb_date_center","27.89%","11.04%","1.72%","3.58%",null,null,null,null,null,null,this.div_attendance_emp.form);
            obj.set_taborder("3");
            obj.set_text("~");
            ...
            obj = new Calendar("cal_end_date","30.39%","10.75%","15.63%","5.22%",null,null,null,null,null,null,this.div_attendance_emp.form);
            obj.set_taborder("4");
            obj.set_type("normal");
            obj.set_dateformat("yyyy-MM-dd");
            this.div_attendance_emp.addChild(obj.name, obj);

            obj = new Static("lb_emp_name","62.19%","11.04%","7.81%","4.48%",null,null,null,null,null,null,this.div_attendance_emp.form);
            obj.set_taborder("5");
            obj.set_text("사원명");
            obj.set_font("14px/normal \"Malgun Gothic\",\"Arial\"");
            obj.set_color("black");
            ...
            obj = new Edit("edit_emp_name_search","68.13%","10.75%","15.63%","5.22%",null,null,null,null,null,null,this.div_attendance_emp.form);
            obj.set_taborder("6");
            this.div_attendance_emp.addChild(obj.name, obj);

            obj = new Button("btn_attendance_emp_search","85.16%","10.75%","7.81%","5.07%",null,null,null,null,null,null,this.div_attendance_emp.form);
            obj.set_taborder("7");
            obj.set_text("검색");
            obj.set_background("#333F50");
            ...
            obj = new Grid("grid_attendanceList","2.03%","20.15%","96.09%","71.64%",null,null,null,null,null,null,this.div_attendance_emp.form);
            obj.set_taborder("8");
            ...
            obj = new Button("btn_attendance_add","90.31%","93.43%","7.81%","5.07%",null,null,null,null,null,null,this.div_attendance_emp.form);
            obj.set_taborder("9");
            obj.set_text("근태 등록");
            ...
            obj = new Button("btn_attendance_upd","80.94%","93.43%","7.81%","5.07%",null,null,null,null,null,null,this.div_attendance_emp.form);
            obj.set_taborder("10");
            obj.set_text("수정");
            ...
            obj = new Button("btn_attendance_del","2.03%","93.43%","7.81%","5.07%",null,null,null,null,null,null,this.div_attendance_emp.form);
            obj.set_taborder("11");
            obj.set_text("삭제");
            obj.set_background("#242D40");
            obj.set_border("0px none transparent");
        ...
        // User Script
        this.registerScript("Form_attendance_emp.xfdl", function() {
        /* 체크박스 설정 시작 */
        this.div_attendance_emp_grid_attendanceList_onheadclick = function(obj,e)
        {
        ...
        this.div_attendance_emp_btn_attendance_add_onclick = function(obj,e)
        {
        	alert("근태 등록");
        ...
        this.div_attendance_emp_btn_attendance_upd_onclick = function(obj,e)
        {
        	alert("근태 수정");
        	var objChildFrame = new ChildFrame();//ChildFrame생성
        ...
        this.div_attendance_emp_btn_attendance_del_onclick = function(obj,e)
        {
        ...
        {
            this.div_attendance_emp.form.grid_attendanceList.addEventHandler("onheadclick",this.div_attendance_emp_grid_attendanceList_onheadclick,this);
            this.div_attendance_emp.form.btn_attendance_add.addEventHandler("onclick",this.div_attendance_emp_btn_attendance_add_onclick,this);
            this.div_attendance_emp.form.btn_attendance_upd.addEventHandler("onclick",this.div_attendance_emp_btn_attendance_upd_onclick,this);
            this.div_attendance_emp.form.btn_attendance_del.addEventHandler("onclick",this.div_attendance_emp_btn_attendance_del_onclick,this);
        };

        this.loadIncludeScript("Form_attendance_emp.xfdl");
