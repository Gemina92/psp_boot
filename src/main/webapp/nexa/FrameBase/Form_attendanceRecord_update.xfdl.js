(function()
{
    return function()
    {
        ...
        {
            this.set_name("Form_attendanceRecord_update");
            ...
            obj = new Static("lb_attendanceRecord_update_center","2.5%","12.5%","95%","73.25%",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_background("#EDEFF3");
            obj.set_border("0px none transparent");
            this.addChild(obj.name, obj);

            obj = new Static("lb_attendanceRecord_update","0%","0%","100%","10%",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("근태항목 수정");
            ...
            obj = new Static("lb_attendanceRecord_no","8.75%","17.25%","25%","7.5%",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("근태코드");
        ...
        this.loadIncludeScript("Form_attendanceRecord_update.xfdl");
