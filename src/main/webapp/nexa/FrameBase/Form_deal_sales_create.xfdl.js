(function()
{
    return function()
    {
        ...
        {
            this.set_name("Form_deal_sales_create");
            ...
            obj = new Static("lb_deal_sales","0%","0%","100%","6.45%",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("매출거래 등록");
            ...
            obj = new Static("lb_deal_sales_center","1.3%","8.06%","97.4%","83.23%",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Button("btn_deal_sales_create","85.71%","92.9%","12.99%","5.48%",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("등록");
            obj.set_background("#333F50");
            obj.set_border("0px none transparent");
        ...
        // User Script
        this.registerScript("Form_deal_sales_create.xfdl", function() {
        /* 거래처명 찾기 버튼 이벤트 시작 */
        ...
        this.loadIncludeScript("Form_deal_sales_create.xfdl");
