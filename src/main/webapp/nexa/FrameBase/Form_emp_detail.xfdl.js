(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_emp_detail_update","85.71%","92.9%","12.99%","5.48%",null,null,null,null,null,null,this);
            obj.set_taborder("33");
            obj.set_text("수정");
            obj.set_background("#333F50");
            obj.set_border("0px none transparent");
        ...
        // User Script
        this.registerScript("Form_emp_detail.xfdl", function() {
        ...
        this.btn_emp_detail_update_onclick = function(obj,e)
        {
        ...
        this.Form_emp_detail_onload = function(obj,e)
        {
        	//폼이 로드됐을 때 발생하는 이벤트
        ...
        {
            this.addEventHandler("onload",this.Form_emp_detail_onload,this);
            ...
            this.btn_emp_detail_update.addEventHandler("onclick",this.btn_emp_detail_update_onclick,this);
        };

        this.loadIncludeScript("Form_emp_detail.xfdl");
