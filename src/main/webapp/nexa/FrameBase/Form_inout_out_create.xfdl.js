(function()
{
    return function()
    {
        ...
        {
            this.set_name("Form_inout_out_create");
            ...
            obj = new Static("lb_out_create","0%","0%","100%","8.33%",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("출고 등록");
            ...
            obj = new Static("lb_out_create_center","1.3%","10%","97.4%","78.75%",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Static("lb_out_date","53.51%","33.13%","12.99%","6.25%",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("출고일자");
            obj.set_textAlign("left");
            obj.set_font("14px/normal \"Malgun Gothic\",\"Arial\"");
            ...
            obj = new Calendar("cal_out_date","67.92%","32.71%","23.38%","7.29%",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_out_create","85.71%","90.83%","12.99%","7.08%",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_text("등록");
            obj.set_background("#333F50");
            obj.set_border("0px none transparent");
        ...
        // User Script
        this.registerScript("Form_inout_out_create.xfdl", function() {
        /* 거래처 코드 조회 popupdiv */
        ...
        this.loadIncludeScript("Form_inout_out_create.xfdl");
