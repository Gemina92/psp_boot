(function()
{
    return function()
    {
        ...
        {
            this.set_name("Form_approval_mgr_decide");
            ...
            obj = new Div("div_approval_mgr_decide","0%","0%","100%","100%",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            this.addChild(obj.name, obj);

            obj = new Static("lb_approval_mgr_decide","0%","0%","100%","5.22%",null,null,null,null,null,null,this.div_approval_mgr_decide.form);
            obj.set_taborder("0");
            obj.set_text("기결함 조회");
            ...
            this.div_approval_mgr_decide.addChild(obj.name, obj);

            obj = new Static("lb_approval_mgr_decide_search","2.03%","7.31%","96.09%","11.94%",null,null,null,null,null,null,this.div_approval_mgr_decide.form);
            obj.set_taborder("1");
            ...
            obj = new Static("lb_write_date","5.63%","11.04%","6.25%","4.48%",null,null,null,null,null,null,this.div_approval_mgr_decide.form);
            obj.set_taborder("3");
            obj.set_text("작성일");
            ...
            obj = new Calendar("cal_start_date","11.48%","10.75%","15.63%","5.22%",null,null,null,null,null,null,this.div_approval_mgr_decide.form);
            obj.set_taborder("4");
            obj.set_type("normal");
            this.div_approval_mgr_decide.addChild(obj.name, obj);

            obj = new Static("lb_date_center","27.89%","11.04%","1.72%","3.58%",null,null,null,null,null,null,this.div_approval_mgr_decide.form);
            obj.set_taborder("7");
            obj.set_text("~");
            ...
            obj = new Calendar("cal_end_date","30.39%","10.75%","15.63%","5.22%",null,null,null,null,null,null,this.div_approval_mgr_decide.form);
            obj.set_taborder("5");
            obj.set_type("normal");
            this.div_approval_mgr_decide.addChild(obj.name, obj);

            obj = new Button("btn_approval_mgr_decide_search","86.41%","10.75%","7.81%","5.07%",null,null,null,null,null,null,this.div_approval_mgr_decide.form);
            obj.set_taborder("2");
            obj.set_text("검색");
            obj.set_background("#333F50");
            ...
            obj = new Grid("grid_approvalList","2.03%","20.15%","96.09%","71.64%",null,null,null,null,null,null,this.div_approval_mgr_decide.form);
            obj.set_taborder("6");
        ...
        // User Script
        this.registerScript("Form_approval_mgr_decide.xfdl", function() {

        /* 체크박스 설정 시작 */
        this.div_approval_mgr_decide_grid_approvalList_onheadclick = function(obj,e)
        {
        ...
        this.div_approval_mgr_decide_grid_approvalList_oncelldblclick = function(obj,e)
        {
        ...
        this.div_approval_mgr_decide_btn_approval_mgr_decide_search_onclick = function(obj,e)
        {
        	//검색
        ...
        {
            this.div_approval_mgr_decide.form.lb_approval_mgr_decide_search.addEventHandler("onclick",this.div_approval_delay_lb_file_search_onclick,this);
            this.div_approval_mgr_decide.form.btn_approval_mgr_decide_search.addEventHandler("onclick",this.div_approval_mgr_decide_btn_approval_mgr_decide_search_onclick,this);
            this.div_approval_mgr_decide.form.grid_approvalList.addEventHandler("onheadclick",this.div_approval_mgr_decide_grid_approvalList_onheadclick,this);
            this.div_approval_mgr_decide.form.grid_approvalList.addEventHandler("oncelldblclick",this.div_approval_mgr_decide_grid_approvalList_oncelldblclick,this);
        };

        this.loadIncludeScript("Form_approval_mgr_decide.xfdl");
