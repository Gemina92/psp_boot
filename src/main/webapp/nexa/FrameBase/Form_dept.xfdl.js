(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"DEPT_CK\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NO\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_USE\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NOTE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows/>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Div("div_dept","0%","0%","100%","100%",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            this.addChild(obj.name, obj);

            obj = new Static("lb_dept","0%","0%","100%","5.22%",null,null,null,null,null,null,this.div_dept.form);
            obj.set_taborder("0");
            obj.set_text("부서 관리");
            ...
            this.div_dept.addChild(obj.name, obj);

            obj = new Static("lb_dept_search","2.03%","7.31%","96.09%","11.94%",null,null,null,null,null,null,this.div_dept.form);
            obj.set_taborder("1");
            ...
            obj = new Static("lb_dept_name","5.63%","11.04%","4.69%","4.48%",null,null,null,null,null,null,this.div_dept.form);
            obj.set_taborder("2");
            obj.set_text("부서명");
            this.div_dept.addChild(obj.name, obj);

            obj = new Edit("edit_dept_name_search","11.48%","10.75%","15.63%","5.22%",null,null,null,null,null,null,this.div_dept.form);
            obj.set_taborder("3");
            this.div_dept.addChild(obj.name, obj);

            obj = new Button("btn_dept_search","33.28%","10.75%","7.81%","5.07%",null,null,null,null,null,null,this.div_dept.form);
            obj.set_taborder("4");
            obj.set_text("검색");
            obj.set_background("#333F50");
            ...
            obj = new Grid("grid_deptList","2.03%","20.15%","96.09%","71.64%",null,null,null,null,null,null,this.div_dept.form);
            obj.set_taborder("5");
            obj.set_color("black");
            obj.set_binddataset("ds_deptList");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"250\"/><Column size=\"250\"/><Column size=\"200\"/><Column size=\"428\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"부서번호\"/><Cell col=\"2\" text=\"부서이름\"/><Cell col=\"3\" text=\"사용구분\"/><Cell col=\"4\" text=\"비고\"/></Band><Band id=\"body\"><Cell text=\"bind:DEPT_CK\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"bind:DEPT_NO\"/><Cell col=\"2\" text=\"bind:DEPT_NAME\"/><Cell col=\"3\" text=\"bind:DEPT_USE\"/><Cell col=\"4\" text=\"bind:DEPT_NOTE\"/></Band></Format></Formats>");
            this.div_dept.addChild(obj.name, obj);

            obj = new Button("btn_dept_add","90.31%","93.43%","7.81%","5.07%",null,null,null,null,null,null,this.div_dept.form);
            obj.set_taborder("6");
            obj.set_text("부서등록");
            ...
            obj = new Button("btn_dept_upd","80.94%","93.43%","7.81%","5.07%",null,null,null,null,null,null,this.div_dept.form);
            obj.set_taborder("7");
            obj.set_text("수정");
            ...
            obj = new Button("btn_dept_del","2.03%","93.43%","7.81%","5.07%",null,null,null,null,null,null,this.div_dept.form);
            obj.set_taborder("8");
            obj.set_text("삭제");
            obj.set_background("#242D40");
            obj.set_border("0px none transparent");
        ...
        /* 체크박스 설정 시작 */
        this.div_dept_grid_deptList_onheadclick = function(obj,e)
        {
        ...
        this.div_dept_btn_dept_add_onclick = function(obj,e)
        {
        	//alert("부서등록");
        ...
        this.div_dept_btn_dept_upd_onclick = function(obj,e)
        {
        	var count = 0;
        	//alert("부서수정 버튼 클릭");
        	var p_deptNo = '';
        ...
        this.div_dept_btn_dept_del_onclick = function(obj,e)
        {
        	var count = 0;
        	//alert("삭제버튼 클릭");
        	var p_deptNo = '';
        ...
        this.div_dept_btn_dept_search_onclick = function(obj,e)
        {
        	//alert("검색버튼 클릭");
        ...
        {
            this.div_dept.form.btn_dept_search.addEventHandler("onclick",this.div_dept_btn_dept_search_onclick,this);
            this.div_dept.form.grid_deptList.addEventHandler("onheadclick",this.div_dept_grid_deptList_onheadclick,this);
            this.div_dept.form.btn_dept_add.addEventHandler("onclick",this.div_dept_btn_dept_add_onclick,this);
            this.div_dept.form.btn_dept_upd.addEventHandler("onclick",this.div_dept_btn_dept_upd_onclick,this);
            this.div_dept.form.btn_dept_del.addEventHandler("onclick",this.div_dept_btn_dept_del_onclick,this);
        };
