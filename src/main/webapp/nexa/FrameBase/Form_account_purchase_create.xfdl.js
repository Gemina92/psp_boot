(function()
{
    return function()
    {
        ...
        {
            this.set_name("Form_account_purchase_create");
            ...
            obj = new Static("lb_account_purchase_create","0%","0%","100%","6.45%",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("매입 거래처 등록");
            ...
            obj = new Static("lb_account_purchase_create_center","1.3%","8.06%","97.4%","83.23%",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Static("lb_crops_no","55.06%","32.42%","12.99%","4.84%",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("농산물 코드");
            obj.set_textAlign("left");
            obj.set_font("14px/normal \"Malgun Gothic\",\"Arial\"");
            ...
            obj = new Edit("edit_crops_no","69.48%","32.1%","23.38%","5.65%",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_font("12px/normal \"Malgun Gothic\",\"Arial\"");
            obj.set_textAlign("left");
            obj.set_visible("true");
            ...
            obj = new Button("btn_crops_no_search","92.99%","32.42%","3.9%","4.84%",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_border("0px none transparent");
            ...
            obj = new Button("btn_account_purchase_create","85.71%","92.9%","12.99%","5.48%",null,null,null,null,null,null,this);
            obj.set_taborder("30");
            obj.set_text("등록");
            obj.set_background("#333F50");
            obj.set_border("0px none transparent");
        ...
        // User Script
        this.registerScript("Form_account_purchase_create.xfdl", function() {
        ...
        this.loadIncludeScript("Form_account_purchase_create.xfdl");
