(function()
{
    return function()
    {
        ...
        {
            this.set_name("Form_rank_update");
            ...
            obj = new Static("lb_rank_update","0%","0%","100%","10%",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("직급 수정");
            ...
            obj = new Static("lb_rank_update_center","2.5%","12.5%","95%","73.25%",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Button("btn_rank_update","72.5%","89%","25%","8.5%",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("수정");
            obj.set_background("#333F50");
            obj.set_border("0px none transparent");
        ...
        // User Script
        this.registerScript("Form_rank_update.xfdl", function() {
        ...
        this.Form_rank_update_onload = function(obj,e)
        {
        	//폼이 로드된 후 발생하는 이벤트
        ...
        this.btn_rank_update_onclick = function(obj,e)
        {
        	//alert("직급수정버튼 클릭");
        ...
        {
            this.addEventHandler("onload",this.Form_rank_update_onload,this);
            this.btn_rank_no_check.addEventHandler("onclick",this.btn_rank_no_check_onclick,this);
            this.btn_rank_update.addEventHandler("onclick",this.btn_rank_update_onclick,this);
        };

        this.loadIncludeScript("Form_rank_update.xfdl");
