(function()
{
    return function()
    {
        ...
        {
            this.set_name("Form_attendance_update");
            ...
            obj = new Static("lb_attendance_update","0%","0%","100%","10%",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Static("lb_attendance_update_center","1.3%","12%","97.4%","73.25%",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Static("lb_emp_name","43.51%","33.5%","9.09%","7.5%",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("사원명");
            obj.set_font("14px/normal \"Malgun Gothic\",\"Arial\"");
            obj.set_color("black");
            ...
            obj = new Button("btn_attendance_update","85.71%","89%","12.99%","8.5%",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("수정");
            obj.set_background("#333F50");
        ...
        // User Script
        this.registerScript("Form_attendance_update.xfdl", function() {
        /* 일자 구하기 이벤트 시작 */
        ...
        this.loadIncludeScript("Form_attendance_update.xfdl");
