(function()
{
    return function()
    {
        ...
        {
            this.set_name("Form_branch_detail");
            ...
            obj = new Static("lb_branch_detail","0%","0%","100%","8.33%",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_background("#333F50");
            obj.set_color("#ffffff");
            obj.set_font("bold 12pt/normal \"Malgun Gothic\",\"Arial\"");
            obj.set_padding("0px 0px 0px 10px");
            obj.set_text("지점 상세보기");
            this.addChild(obj.name, obj);

            obj = new Static("lb_branch_detail_center","1.3%","10%","97.4%","78.75%",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Static("lb_branch_addr","4.55%","62.29%","12.99%","6.25%",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("지점주소");
            obj.set_textAlign("left");
            obj.set_font("14px/normal \"Malgun Gothic\",\"Arial\"");
            ...
            obj = new Button("btn_zipcode_search","44.29%","61.88%","7.79%","7.29%",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("찾기");
            obj.set_background("#333F50");
            ...
            obj = new Edit("edit_branch_addr","20.39%","72.29%","59.09%","7.29%",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_font("12px/normal \"Malgun Gothic\",\"Arial\"");
            obj.set_textAlign("left");
            obj.set_visible("true");
            ...
            obj = new Button("btn_branch_upd","85.71%","90.83%","12.99%","7.08%",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("수정");
            obj.set_background("#333F50");
            obj.set_border("0px none transparent");
        ...
        // User Script
        this.registerScript("Form_branch_detail.xfdl", function() {
        ...
        this.btn_branch_upd_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn_branch_upd.addEventHandler("onclick",this.btn_branch_upd_onclick,this);
        };

        this.loadIncludeScript("Form_branch_detail.xfdl");
