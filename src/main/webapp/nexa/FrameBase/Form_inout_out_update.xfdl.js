(function()
{
    return function()
    {
        ...
        {
            this.set_name("Form_inout_out_update");
            ...
            obj = new Static("lb_out_update","0","0","770","40",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("출고 수정");
            ...
            obj = new Static("lb_out_update_center","10","48","750","378",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Button("btn_out_update","660","436","100","34",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_text("수정");
            obj.set_background("#333F50");
            obj.set_border("0px none transparent");
        ...
        // User Script
        this.registerScript("Form_inout_out_update.xfdl", function() {
        /* 거래처 코드 조회 popupdiv */
        ...
        this.loadIncludeScript("Form_inout_out_update.xfdl");
